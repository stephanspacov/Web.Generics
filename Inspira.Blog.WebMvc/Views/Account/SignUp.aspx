<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Views/Shared/Site.Master" Inherits="System.Web.Mvc.ViewPage<Inspira.Blog.WebMvc.ViewModels.Account.SignUpViewModel>" %>
        ...
        <div class="content">
            ...
            <div class="inner">
                ...
                <div class="group fieldWithErrors">
                    <label class="label">
                        Name:
                        <span class="error"><%= Html.ValidationMessageFor(v => v.Name) %></span>
                    </label>
                    <%= Html.TextBoxFor(v => v.Name, new { @class = "text_field" })%>
                ...
                <div class="group fieldWithErrors">
                    <label class="label">
                        Blog title:
                        <span class="error"><%= Html.ValidationMessageFor(v => v.BlogTitle) %></span>
                    </label>
                    <%= Html.TextBoxFor(v => v.BlogTitle, new { @class = "text_field" })%>
                    <span class="description">Ex: Mark's Blog</span>
                </div>
                <div class="group fieldWithErrors">
                    <label class="label">
                        Password:
